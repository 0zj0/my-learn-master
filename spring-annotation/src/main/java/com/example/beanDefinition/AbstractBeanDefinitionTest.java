...
public abstract class AbstractBeanDefinitionTest extends BeanMetadataAttributeAccessor
    ...
    /**
     * 表示 通过名称自动装配 bean 属性的常量
     */
    public static final int AUTOWIRE_BY_NAME = AutowireCapableBeanFactory.AUTOWIRE_BY_NAME;

    /**
     * 表示 通过类型 自动装配 bean 属性的常量
     */
    ...
    /**
     * 表示 通过对象应用 进行 依赖校验 的常量
     */
    public static final int DEPENDENCY_CHECK_OBJECTS = 1;

    /**
     * 表示 通过 “simple” 属性 进行 依赖校验 的常量
     */
    public static final int DEPENDENCY_CHECK_SIMPLE = 2;

    /**
     * 表示 通过 所有属性 进行 依赖校验 的常量（包含 “simple” 属性 及 对象应用）
     */
     ...
     */
    protected AbstractBeanDefinitionTest() {
        this(null, null);
    }
     ...
     */
    protected AbstractBeanDefinitionTest(@Nullable ConstructorArgumentValues cargs, @Nullable MutablePropertyValues pvs) {
     ...
     */
    protected AbstractBeanDefinitionTest(BeanDefinition original) {
     ...
     */
    public void copyQualifiersFrom(AbstractBeanDefinitionTest source) {
    ...
    public void setOriginatingBeanDefinition(BeanDefinition originatingBd) {
        //this.resource = new AbstractBeanDefinitionTest(originatingBd);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof AbstractBeanDefinitionTest)) {
            return false;
        }
        AbstractBeanDefinitionTest that = (AbstractBeanDefinitionTest) other;
